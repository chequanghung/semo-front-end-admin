      ...
      <div class="form" style="margin-top: 32px;">
        ...
        <div class="columns is-centered is-multiline">
          ...
          <div class="column is-two-thirds">
            ...
            <!-- sugar -->
            <div class="page-section">
              <p class="page-content-text title" :class="{'edited' : edit_sugar_pct}">Nồng độ đường</p>
              <!-- answer -->
              <div class="page-answer">
                <p
                  class="page-content-text"
            ...
            <!-- info -->
            <div class="page-section">
              <p class="page-content-text title" :class="{'edited' : edit_notes}">Thông tin chi tiết</p>
              <!-- answer -->
              <div class="page-answer">
                <p
                  class="page-content-text"
          ...
          <div class="column is-two-thirds">
            ...
            <!-- title -->
            <div class="page-section">
              <p class="page-content-text title" :class="{'edited' : edit_price_init}">Giá khởi điểm</p>
              <!-- answer -->
              <div class="page-answer">
                <p
                  class="page-content-text"
